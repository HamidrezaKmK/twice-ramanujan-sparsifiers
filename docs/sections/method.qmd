...
```{python}
#| label: fig-barbell
#| fig-cap: "The Twice-Ramanujan sparsifier in action, sparsifiying the barbel graph, edges with more strength correspond to larger weights."
...
tr = TwiceRamanujan(g, d=2, verbose=1)
